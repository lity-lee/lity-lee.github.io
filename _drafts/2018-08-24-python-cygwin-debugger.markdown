...
category: android
title:  "一套python开发环境"
tags: [cygwin,python,pycharm]
---

windows开发python, 基础环境的安装很简单。1、可以直接从[官方](https://www.python.org)下载, 安装即可；2、在cygwin终端时使用apt-cyg安装。然而这两种方案差异性还是挺大的，主要也不“完美”。方案1在使用需要编译的模块时（如：pycrypto‎），需要编译环境VC++, 而windows编译环境
